...
namespace TkBundleExample\Core\Content\Bundle\Aggregate\BundleProduct;
...
/**
 * Class BundleProductDefinition
 * Mapping table for bundle product association
 * @package TkBundleExample\Core\Content\Bundle\Aggregate\BundleProduct
 */
